...
train_images_path = "/data/fangwen/results/level3/chip_train_set/rgb_img/"
train_segs_path = "/data/fangwen/results/level3/chip_train_set/3_greylabel/"
train_mask_path = "/data/fangwen/results/level3/chip_train_set/2_mask/"
...
if train_mode == "BGR":
    ...
    train_f_path = "/data/fangwen/results/level3/chip_train_set/"
    val_f_path = "/data/fangwen/results/level3/chip_validation_set/"
...
##################
if validate:
    val_images_path = "/data/fangwen/results/level3/chip_validation_set/rgb_img/"
    val_segs_path = "/data/fangwen/results/level3/chip_validation_set/3_greylabel/"
    val_mask_path = "/data/fangwen/results/level3/chip_validation_set/2_mask/"
    ...
    callbacks = [EarlyStopping(monitor='val_loss', patience=100),
                 ...
                 ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=30, min_lr=0.0001),
    ...
    m.fit_generator(G,
                    steps_per_epoch=9722//train_batch_size,
                    callbacks=callbacks,
                    validation_data=G2,
                    validation_steps=1929//val_batch_size,
                    epochs=10000,
