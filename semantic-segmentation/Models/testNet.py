...
from keras.layers import Input, Conv2D, Activation, Reshape, Dropout, concatenate
...
input_width=480
	...
	auxiliary_input = Input(shape=(input_height,input_width, 1), name='aux_input')
	...
	conv_2 = concatenate([Activation("relu")(conv_2), conv_2_], axis=3)
	...
	conv_4 = concatenate([Activation("relu")(conv_4), conv_4_], axis=3)
	...
	conv_7 = concatenate([Activation("relu")(conv_7), conv_7_], axis=3)
	...
	conv_10 = concatenate([Activation("relu")(conv_10), conv_10_], axis=3)
	...
	conv_13 = concatenate([Activation("relu")(conv_13), conv_13_], axis=3)
