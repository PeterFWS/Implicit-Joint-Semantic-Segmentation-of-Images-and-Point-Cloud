...
train_images_path = ["/data1/thesis_fangwen/mix_train/rgb_img/"]
train_segs_path = ["/data1/thesis_fangwen/mix_train/3_greylabel/"]
train_mask_path = ["/data1/thesis_fangwen/mix_train/2_mask/"]
...
G1 = LoadBatches_multi_stream.imageSegmentationGenerator(train_images_path, train_segs_path, train_mask_path,
                                           ["/data1/thesis_fangwen/mix_train/"],
                                           batch_size, n_classes, input_height, input_width,
                                           output_height=input_height, output_width=input_width, data_aug=True)

if validate:
    val_images_path = ["/data1/thesis_fangwen/mix_validation/rgb_img/"]
    val_segs_path = ["/data1/thesis_fangwen/mix_validation/3_greylabel/"]
    val_mask_path = ["/data1/thesis_fangwen/mix_validation/2_mask/"]



    G2 = LoadBatches_multi_stream.imageSegmentationGenerator(val_images_path, val_segs_path, val_mask_path,
                                                ["/data1/thesis_fangwen/mix_validation/"],
                                                batch_size, n_classes, input_height,input_width,
    ...
    m.fit_generator(G1,
                    steps_per_epoch=15925//batch_size,
                    callbacks=callbacks,
                    validation_data=G2,
